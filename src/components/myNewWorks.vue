      ...
      <div class="project-container col-md-3 p-0 m-2">
        ...
        >
          <div class="project card mb-4">
            <img
              src="../assets/images/projects-logo/project-logo-8.png"
              class="card-img-top"
              alt="project-image"
            />
            <h5 class="card-title p-3">Wisdom Store</h5>
          </div>
        </a>
        <!-- source code link -->
        <a
          class="github-icon"
          href="https://github.com/fathi-fayez/wisdom-store"
          target="_blank"
...
.my-work {
  ...
  .project::before {
    ...
    background-color: rgb(3 169 244 / 18%);
    width: 0;
    height: 0;
    transition: 3s;
    opacity: 0;
